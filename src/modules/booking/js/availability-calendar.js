(function ($) {
	...
	AvailabilityCalendar.prototype = {
		...
		__createToolbar: function () {
			...
			$inputContainer.append('<button type="button" class="btn btn-primary" title="This month">Ten miesiąc</button>');
			$inputContainer.append('<button type="button" class="btn btn-warning" title="Previous month">&#10094;</button>');
			$inputContainer.append('<button type="button" class="btn btn-warning" title="Next month">&#10095;</button>');

			var $inputs = $inputContainer.children('button');
			var self = this;
