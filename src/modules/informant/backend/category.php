...
class Category
{
    public static $table     = "informant_category";
    public static $table_i18 = "informant_category_i18";

    public static $Error = array();

    protected static $UploadDirectory = 'userfiles/informant/category/';
    ...
    {
        Navigation::submenu('informant' , 'Kategorie' , 'informant/category/list');
        Kernel::registerComponent( 100 , "Informator - kategorie" , "informant/category/index");
    }
